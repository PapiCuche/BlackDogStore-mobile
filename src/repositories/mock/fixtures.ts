...
export const mockOrders: readonly Order[] = [
  {
    ...
    createdAt: days(1),
    items: [
      { id: 1, product: airPodsPro2, quantity: 1, price: '899.00' },
      { id: 2, product: charger20W, quantity: 1, price: '129.00' },
    ],
  },
  {
    id: 1037,
    ...
    paidAt: days(16),
    createdAt: days(17),
    items: [{ id: 3, product: macbookAirM3, quantity: 1, price: '5299.00' }],
  },
  {
    id: 1030,
    customerName: 'Carlos Mau',
    ...
    paidAt: null,
    createdAt: days(31),
    items: [{ id: 4, product: charger20W, quantity: 1, price: '129.00' }],
  },
];
